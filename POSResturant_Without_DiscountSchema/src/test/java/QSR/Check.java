...
public class Check extends Action_Clas {
	Xls_Reader reader = 
//			new Xls_Reader("D:\\Ankita Data\\AnkitaBackup\\eclipse\\Workspace\\Rest_Project\\src/test/java\\Result\\Check.xlsx");
	new Xls_Reader("C:\\Users\\gaurav.raghuwanshi\\Documents\\POS_Script_Content\\Project\\POS_Resturant\\Excel\\Check.xlsx");
	...
	public void QSRs(String SheetName) throws Exception {
		...
		for (int i = 2; i <= rowCount; i++) {
			...
			System.out.println(" Value of Refrence ID : "+ref1);
			...
			if (runOn.equals("ON")) {
				for (int j = 2; j <= rowCount2; j++) {
					...
					System.out.println("QSR Data Value of Refrence ID : "+ref);
...
/*		Pattern p = new Pattern(
				"D:\\Ankita Data\\AnkitaBackup\\eclipse\\Workspace\\Rest_Project\\Sikulli Images\\DeliveryDone.PNG");
*/
		Pattern p = new Pattern(
				"C:\\Users\\gaurav.raghuwanshi\\Documents\\POS_Script_Content\\Project\\POS_Resturant\\Sikulli_Images\\DeliveryDone.PNG");
