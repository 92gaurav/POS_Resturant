...
public class All_Invoices extends Action_Clas {
...
//			new Common_Class.Xls_Reader("D:\\eclipse\\Workspace\\Rest_Project\\src/test/java\\Result\\Restaurant_Project.xlsx");
	...
	public void dyNamic(String SheetName) throws Exception {
		...
		int rowCount2 = reader.getRowCount("PickUp_Data");
		for (int i = 2; i <= rowCount; i++) {
			...
			if (runOn.equals("ON")) {
				...
				for (int j = 2; j <= rowCount2; j++) {
					...
					String ref = reader.getCellData("PickUp_Data", "Refrence Id", j);
					if (ref1.equalsIgnoreCase(ref)) {
						UserName = reader.getCellData("PickUp_Data", "UserName", j);
						String HTMLPassword = reader.getCellData("PickUp_Data", "HtmlPassword", j);
						POSTerminal = reader.getCellData("PickUp_Data", "Pos Terminal", j);
						String POSTerminalUser = reader.getCellData("PickUp_Data", "Pos Temrinal User", j);
						String course = reader.getCellData("PickUp_Data", "Course", j);
						String cate = reader.getCellData("PickUp_Data", "Category", j);
						String paro = reader.getCellData("PickUp_Data", "PRODUCT", j);
						Cash = reader.getCellData("PickUp_Data", "Cash", j);
						card = reader.getCellData("PickUp_Data", "Card", j);
						multiCard = reader.getCellData("PickUp_Data", "CardMultiCurrency", j);
						oncredit = reader.getCellData("PickUp_Data", "OnCredit", j);
						customername = reader.getCellData("PickUp_Data", "CustomerName", j);
						dicountpercentage = reader.getCellData("PickUp_Data", "Discount Percentage", j);
						discountamount = reader.getCellData("PickUp_Data", "Discount Amount", j);
						discountPerTotalamount = reader.getCellData("PickUp_Data", "Total Discount Amount", j);
						discountPerTotalpercentage = reader.getCellData("PickUp_Data", "Total Discount Percentage", j);
						DiscountProduct = reader.getCellData("PickUp_Data", "Discounted Product", j);
						discountPerTotal = reader.getCellData("PickUp_Data", "Discount Total", j);
						Void = reader.getCellData("PickUp_Data", "Void", j);
						TotalVoid = reader.getCellData("PickUp_Data", "Full OrderVoid", j);
						MultiCash = reader.getCellData("PickUp_Data", "CashMultiDenomination", j);
						CurrencyType = reader.getCellData("PickUp_Data", "CashMulti Curency", j);
						driverin = reader.getCellData("PickUp_Data", "Driver In", j);
						duebillpayment = reader.getCellData("PickUp_Data", "Due Bill Payment", j);
						modifier = reader.getCellData("PickUp_Data", "Modifier", j);
						modifierproduct = reader.getCellData("PickUp_Data", "Modifier Product", j);
						onCredit = reader.getCellData("PickUp_Data", "On Credit", j);
						CreditAmount = reader.getCellData("PickUp_Data", "Credit Amount", j);
						 ReturnWithoutInvoice =  reader.getCellData("PickUp_Data", "ReturnWithoutInvoice", j);
						 CreditKeyPadDenominationValue = reader.getCellData("PickUp_Data", "OnCreditVirtual KeypadAmount", j);
						 OnCreditKeyPad = reader.getCellData("PickUp_Data", "OnCreditVirtual Keypad", j);
						 CreditSettelment =  reader.getCellData("PickUp_Data", "Credit Card Settlement", j);
						 OccupiedTermninal= reader.getCellData("PickUp_Data", "POS Terminal ON HTML", j);
						 Prefix=  reader.getCellData("PickUp_Data", "OrderPrefix", j);
						 String Password = reader.getCellData("PickUp_Data", "Password", j);
...
*/
	...
	public void DueBillPayment() throws InterruptedException {
		...
		if (duebillpayment.equals("Y")){
			...
			String Count = driver.findElement(By.id("POSVA019_PickupCount")).getText();
			click_On_Button("id", "POSVA019_btnPickup");
			Thread.sleep(2000);
...
*/
	...
	public void cardPay(String cardNo) throws InterruptedException, FindFailed {
		if (card.equals("NA") == false) {
			 ...
			 Pattern p = new Pattern("C:\\Users\\gaurav.raghuwanshi\\Documents\\POS_Script_Content\\Project\\POS_Resturant\\Sikulli_Images\\AuthDone.PNG");
			  Pattern p1 = new Pattern("C:\\Users\\gaurav.raghuwanshi\\Documents\\POS_Script_Content\\Project\\POS_Resturant\\Sikulli_Images\\Cancel.PNG");
			click_On_Button("id", "POS_Pay");
	...
	public void SyncData() throws InterruptedException{
	 ...
	 public void SalesOrder() throws InterruptedException{
		 ...
		 click_On_Button("id", "vis_appMenu");
			...
			int rowCount = reader.getRowCount("PickUp");
			for (int i = 2; i <= rowCount; i++) {
				runOn = reader.getCellData("PickUp", "RUN", i);
				OrderNum = reader.getCellData("PickUp", "OrderNumber", i);
				if (runOn.equals("ON")) {
		...
		if(DocumentStatus.equalsIgnoreCase("CO")){
					...
					reader.setCellData("PickUp", "GrandTotal(Sales Order)",i, TotalLines);
					reader.setCellData("PickUp", "SubTotal(Sales Order)",i, GrandTotal);
					reader.setCellData("PickUp", "Document status of html(Sales Order)",i, DocumentStatus);
					reader.setCellData("PickUp", "Cash(Sales Order)",i, CashPaid);
					reader.setCellData("PickUp", "Card(Sales Order)",i, CardPaid);
					reader.setCellData("PickUp", "ONCredit(Sales Order)",i, OnCredit);
					reader.setCellData("PickUp", "PaymentMethod(Sales Order)",i, PaymentMethod);
					reader.setCellData("PickUp", "HTML Status(Sales Order)",i, "Passed");
					}
			...
			reader.setCellData("PickUp", "ONCredit(Sales Order)",i, OnCredit);
			reader.setCellData("PickUp", "PaymentMethod(Sales Order)",i, PaymentMethod);
			reader.setCellData("PickUp", "HTML Status(Sales Order)",i, "Fail");
				}
				}
			}
